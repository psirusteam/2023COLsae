...
El resultado nos indica que la tasa de pobreza en la dam 44 es `r round(temp_dam44$mrp_estimate,2)`
...
El resultado nos indica que la tasa de pobreza en la dam2  05001 es `r round(temp_dam2_44001$mrp_estimate,2)`
